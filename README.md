...
It brings to external integrations what Gladys' built-in `lan-manager`
service does for the LAN inside core Gladys (network device presence), and
adds what that internal service does **not** do: sending **Wake-on-LAN**.
